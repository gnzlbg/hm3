/// \file sphere_2d.cpp 2D level-set sphere test
...
int main(int argc, char* argv[]) {
  ...
  auto sphere0       = geometry::implicit::moving_sphere<nd>{radius};
  auto sphere1       = geometry::implicit::moving_sphere<nd>{radius};
