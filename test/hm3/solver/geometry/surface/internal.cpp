...
template struct hm3::solver::geometry::internal_surface<1>;
template struct hm3::solver::geometry::internal_surface<2>;
template struct hm3::solver::geometry::internal_surface<3>;
...
int main() {
  {  // 1D
    ...
    using s_t = solver::geometry::internal_surface<ad>;
