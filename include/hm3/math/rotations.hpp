...
inline Eigen::AngleAxis<num_t> inverse_rotation_matrix_3d_x(num_t angle) {
  return rotation_matrix_3d_x(angle).inverse();
}

/// 3D inverse rotation matrix around the y-axis (angle in radians).
inline Eigen::AngleAxis<num_t> inverse_rotation_matrix_3d_y(num_t angle) {
  return rotation_matrix_3d_y(angle).inverse();
}

/// 3D inverse rotation matrix around the z-axis (angle in radians).
inline Eigen::AngleAxis<num_t> inverse_rotation_matrix_3d_z(num_t angle) {
