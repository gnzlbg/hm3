...
// template <typename T>
// using PopBackable = concepts::rc::models<concepts::PopBackable,
// uncvref_t<T>>;
...
// struct vertex_storage : public Storage {
...
//     return
//     static_cast<storage_t*>(this)->insert(std::forward<Args>(args)...);
//   }

//  private:
//   // Multi pass range that can be inserted into "this" but that does not
//   equal
//   // self.
//   template <typename R>
