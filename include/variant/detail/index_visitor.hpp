...
template <template <size_t...> class F, typename... Args> struct index_visitor {
  template <size_t... Is> auto operator()(meta::size_t<Is>...) && {
    return apply(
...
template <typename T> struct is_index_visitor : false_type {};
