...
flags = {'--asan'               : 'H3_WITH_ASAN',
         '--assertions'         : 'H3_WITH_ASSERTIONS',
         '--coverage'           : 'H3_WITH_COVERAGE',
         '--debug-info'         : 'H3_WITH_DEBUG_INFO',
         '--msan'               : 'H3_WITH_MSAN',
         '--warnings-as-errors' : 'H3_WITH_WARNINGS_AS_ERRORS',
         '--verbose'            : 'H3_VERBOSE_CONFIGURE',
         '--profile'            : 'H3_WITH_PROFILE',
         '--with-stack-tracer'  : 'H3_WITH_STACK_TRACER',
         '--with-vis'           : 'H3_WITH_VISUALIZATION_TOOLS',
         '--with-vtk'           : 'H3_WITH_VTK',
         '--with-polly'         : 'H3_WITH_POLLY',
         '--no-likely'          : 'H3_NO_LIKELY',
         '--no-restrict'        : 'H3_NO_RESTRICT'
      }
