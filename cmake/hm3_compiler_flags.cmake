...
if (HM3_ENABLE_DEBUG_INFO)
  hm3_append_flag(HM3_HAS_G3 -g3)
  if (HM3_ENABLE_DEBUG_INFO_GDB)
    hm3_append_flag(HM3_HAS_GGDB -ggdb3)
  endif()
  if(HM3_ENABLE_DEBUG_INFO_LLDB)
    hm3_append_flag(HM3_HAS_GLLDB -glldb)
  endif()
else()
