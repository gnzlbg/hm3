...
if (CMAKE_BUILD_TYPE STREQUAL "Release")
  ...
  hm3_append_flag(HM3_HAS_EIGEN_FAST_MATH1 "-DEIGEN_FAST_MATH=1")
  #hm3_append_flag(HM3_HAS_FAST_MATH -ffast-math)
  #hm3_append_flag(HM3_HAS_FAST_MATH0 -fno-signed-zeros)
  #hm3_append_flag(HM3_HAS_FAST_MATH1 -freciprocal-math)
  #hm3_append_flag(HM3_HAS_FAST_MATH2 -fno-math-errno)
  #hm3_append_flag(HM3_HAS_FAST_MATH200 -fassociative-math)
  #hm3_append_flag(HM3_HAS_FAST_MATH251 -fno-trapping-math)

  #hm3_append_flag(HM3_HAS_FAST_MATH252 -funsafe-math-optimizations)
  #hm3_append_flag(HM3_HAS_FAST_MATH253 -ffinite-math-only)
  #hm3_append_flag(HM3_HAS_FAST_MATH4 "-ffp-contract=fast")
  #hm3_append_flag(HM3_HAS_FAST_MATH43 -fno-honor-nans)
  #hm3_append_flag(HM3_HAS_FAST_MATH4400 -fno-honor-infinities)
  #hm3_append_flag(HM3_HAS_FAST_MATH9000 "-D__FAST_MATH__")
